	...
	<div class="container">
		...
		<div class="data-tables datatable-dark">
			<table class="display" id="dataTable3" style="width:100%">
				...
				<tbody>
					<?php
					$brg = mysqli_query($conn, "SELECT * FROM sbrg_keluar_212082 sb, sstock_brg_212082 st where sb.idx_212082=st.idx_212082 ORDER BY sb.id_212082 ASC");
					$no = 1;
					...
					?>
						...
						<tr>
							...
							<td><?php 
								//Menghilangkan minus pada keuntungan
								$keuntungan = abs($b['keuntungan_212082']);
