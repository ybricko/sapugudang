                                    ...
                                    <div class="table-responsive">
										...
										<tr>
										 ...
										 <tr class="table-active">
											...
											<td><center>Saya, <strong><?=$_SESSION['user'];?></strong> <span class="badge badge-secondary"><?=$_SESSION['role_212082'];?></span></center> </td>
											<td><center><input type = 'submit' name = 'submit'  class='btn btn-primary btn-sm' value = 'Add Note'/></center></td>
											<tr>
										 </form>
										<?php  
										// Perintah untuk menampilkan data
										$queri="Select * From notes_212082 where status_212082='aktif' Order by id_212082 DESC" ;  //menampikan SEMUA data dari tabel
										...
										$id = $data['id_212082'];
										 echo "  <form method ='POST' action = 'done.php'>
										  ...
										  <td><strong><center>".$data['contents_212082']."</center></strong></td>
										  <td><strong><center>".$data['admin_212082']."</center></strong></td>
										  <td><center><input type = 'hidden' name = 'id_212082' value = '".$data['id_212082']."'> <input type='submit' name = 'submit'  class='btn btn-danger btn-sm' value = 'Delete' formaction='del.php' /></center></td>
										  </form></td>
										  </tr> </form>
										  ";
										 $i++; 
